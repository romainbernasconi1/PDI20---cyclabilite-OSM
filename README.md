...
3 - Utilisation du modèle sur Qgis
  ...
  a. Télécharger le modèlé du dépôt
  b. Ouvrir Qgis (version 3.40.7 recommandée)
  c. Ouvrir l'interface modeleur dans l'onglet traitement
  d. Une fois l'interface ouverte, importer le fichier du modèle
  e. Lancer le script
  f. Dans la nouvelle page qui s'ouvre : 
